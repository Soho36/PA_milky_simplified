...
def main():
    ...
    for name,d in studies.items():
        ...
        generated=report_path(ROOT/name,'REPORT.generated.md')
        report_file=(generated if generated.exists() else report_path(ROOT/name,'REPORT.md')).name
