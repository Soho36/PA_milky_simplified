...
Preserved from the former root README. These are earlier, mostly uncapped experiments, not the current funded-policy conclusion. Some broad claims and implementation descriptions reflect that earlier stage; consult OVERVIEW.md for the current interpretation.
