...
| Add evaluation supply to blocked copying | [Blocked pipeline findings](results/legacy_25k/blocked_pipeline/FINDINGS.generated.md), [protocol](research/legacy_25k/BLOCKED_PIPELINE.md) |
