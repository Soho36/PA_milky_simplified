...
Read the [findings](FINDINGS.md) for interpretation and [all 72 starts side by side](START_MONTHS.md) for the individual outcomes. The [independent audit](audit.json) passed. At the chosen reserve, the two daily policies have identical purchase and trading paths in every start; maximum daily produces more cash in 70 starts and ties in two.
