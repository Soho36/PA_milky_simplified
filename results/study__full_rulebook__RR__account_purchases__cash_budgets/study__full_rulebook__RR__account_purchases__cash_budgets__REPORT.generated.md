# Account purchases: main schedules and separate policy comparisons

132 saved candidates retained. The main scheduled-purchase comparison is quarterly-one, monthly-one and weekly-one. Monthly-two is an expansion comparison. Quarterly-three is historical batch-purchase evidence, excluded from main rankings and recommendations. Replacement and reinvestment are separate operating-policy families.

All families use the same configured cash budgets, 20-live-account cap and payout settings in these saved Legacy 25K results. Single purchases still imply different annual volumes; this is not a pure timing experiment. Net cash excludes contributions and subtracts seat fees. Total includes one permitted terminal request.

## $1,000 initial; $0/month

**Ongoing main-schedule leader:** monthly_one / weekly_excess_retain_31600: $232,440.45.

**Terminal-inclusive main-schedule leader:** monthly_one / daily_minimum_retain_31900: $302,287.21.

### Best tested withdrawal bundle within each purchase policy
...
**Ongoing main-schedule leader:** weekly_one / weekly_excess_retain_31600: $460,918.96.

**Terminal-inclusive main-schedule leader:** weekly_one / daily_minimum_retain_31900: $550,681.87.
...
**Ongoing main-schedule leader:** weekly_one / weekly_excess_retain_31600: $453,735.95.

**Terminal-inclusive main-schedule leader:** weekly_one / daily_minimum_retain_31900: $544,526.53.
...
**Ongoing main-schedule leader:** weekly_one / weekly_excess_retain_31600: $501,273.61.

**Terminal-inclusive main-schedule leader:** weekly_one / daily_minimum_retain_31900: $589,340.13.
...
## Why quarterly-three is historical

Quarterly-three schedules 12 seats a year, like monthly-one, but batches three identical accounts on the same date. Under the shared deterministic tape those accounts share outcomes. The January quarterly phase was the original single-phase winner, not evidence of general superiority. User-supplied phase checks showed large reversals; see [phase sensitivity](study__full_rulebook__RR__account_purchases__cash_budgets__PHASE_SENSITIVITY.md) for attribution and limits. Those checks have not been independently reproduced by this report generator.

No simulation rows were discarded. Existing reader reports and detailed best-run folders may describe the earlier all-policy ranking; use this report for the current comparison scope. See [operating notes](study__full_rulebook__RR__account_purchases__cash_budgets__HOW_THIS_STUDY_WORKS.md) for funding, purchase and withdrawal conventions. Historical results are not forecasts; weekday stability alone is not validation across market periods.
